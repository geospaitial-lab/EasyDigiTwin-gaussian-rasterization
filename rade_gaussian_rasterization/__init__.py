...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                (num_rendered, color, depth, mean_depth, normal, opacity, distortion,
                 radii, geomBuffer, binningBuffer, imgBuffer) = _C.rasterize_gaussians(*args)
        ...
        return color, depth, mean_depth, normal, opacity, distortion, radii

    @staticmethod
    def backward(ctx, grad_out_color, grad_out_depth, grad_out_mean_depth, grad_out_normal, grad_out_opacity,
                 grad_out_distortion, ___):
        ...
        if raster_settings.debug:
            ...
            try:
                (grad_means2D, grad_colors_precomp, grad_opacities,
                 ...
                 grad_viewmatrix, grad_projmatrix, grad_campos,
                 grad_tanfovx, grad_tanfovy) = _C.rasterize_gaussians_backward(*args)
            except Exception as ex:
